"""
Django settings for cyman_wears project.
...
# Or if restricting to frontend only:
...
WSGI_APPLICATION = 'cyman_wears.wsgi.application'
...
DATABASES = {
    'default': djdatabase_url.parse(os.getenv('DATABASE_URL', ))
}
...
# Email (Sendinblue/Brevo) settings
